        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <View style={styles.row}>
              ...
              >
                {addingId === item._id ? <ActivityIndicator size="small" color={colors.background} /> : <Text style={styles.addButtonText}>Add</Text>}
              </Pressable>
            </View>
          )}
        />
...
const styles = StyleSheet.create({
  ...
  row: { flexDirection: "row", alignItems: "center", backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, borderRadius: 8, padding: spacing.md },
...
export default AdminAddPlayerScreen;